import pathlib
import complex.test.data

from numpy.testing import assert_almost_equal
from unittest import TestCase
from complex.runner import run_malice, parse_args
...
class IntegrationTest(TestCase):
    def test_end_to_end(self):
        test_path = str(pathlib.Path(complex.test.data.__file__).parent.absolute().joinpath("verl_200111.csv"))
        ...
        args = parse_args([test_path, "--seed",  "1337"])
