...
def CompLEx_Report(optimizer, config, performance, lam, image_dir):
    ...
    regression = optimizer.not_fitness()
    ...
    lower_cl_csp_regression = optimizer.not_fitness(lower_cl_csp_params)
    lower_cl_int_regression = optimizer.not_fitness(lower_cl_int_params)
    ...
    upper_cl_csp_regression = optimizer.not_fitness(upper_cl_csp_params)
    upper_cl_int_regression = optimizer.not_fitness(upper_cl_int_params)
    
    optimizer.mode = 'simulated_peak_generation'
    regression_at_titrant_concs = optimizer.not_fitness()
